...
= 1.2.2 =
Updated /includes/css/cr3ativportfolio.css to remove old styling on linked images.

= 1.2.1 =
Updated /js/filterable.js to correct a[href] WP issue discovered in 4.5 that was breaking the filter and any other js on the page.
